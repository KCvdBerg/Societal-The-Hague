        ...
        if isinstance(next_infra, Sink):
            ...
            if self.waiting_time > 0:
                ...
                if next_infra.unique_id in self.model.waiting_times_dic.keys():
                    self.model.waiting_times_dic[next_infra.unique_id][0] += self.waiting_time
                else:
                    self.model.waiting_times_dic[next_infra.unique_id] = [self.waiting_time, next_infra.road_name]
                return
